...
struct FInitialSpectraComputeShader : public FGlobalShader
{
public:
	DECLARE_GLOBAL_SHADER(FInitialSpectraComputeShader);

	SHADER_USE_PARAMETER_STRUCT(FInitialSpectraComputeShader, FGlobalShader);
